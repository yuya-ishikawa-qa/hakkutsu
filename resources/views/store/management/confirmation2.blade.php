...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-sm-8">
                <p class="pl-2">この内容でよろしければ「変更する」ボタンを押してください。</p>
            {!! Form::open(['url' => 'stores/management/update','method' => 'post']) !!}    
        ...
        <div class="container">
                <div class="row  justify-content-center">
                    <div class="col-sm-6 mt-3">
                        {!! Form::submit('変更する', ['name' => 'action', 'class' => 'btn btn-warning btn-block']) !!}
                    </div>
                </div>
    {!! Form::close() !!}
